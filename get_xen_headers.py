...
if __name__ == '__main__':
    ...
    copy_file('public', '.', 'memory.h')
    copy_file('public', '.', 'sched.h')
    copy_file('public', '.', 'event_channel.h')
    copy_file('public', '.', 'grant_table.h')

    copy_file('xen', '.', 'errno.h')
    ...
    copy_file('public\\hvm', 'hvm', 'hvm_op.h')
    copy_file('public\\hvm', 'hvm', 'params.h')

    copy_file('public\\io', 'io', 'xs_wire.h')
    copy_file('public\\io', 'io', 'blkif.h')
